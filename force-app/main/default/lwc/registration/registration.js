...
import isEmailExist from '@salesforce/apex/communityreglogin.isEmailExist';
import registerUser from '@salesforce/apex/communityreglogin.registerUser';
...
export default class RegisterComponent extends LightningElement {
    ...
    showUserName;
     ...
     showTermsAndConditionsLoading = false;
     infoTooltipDisplayData = {};
     requiredTooltipDisplayData = {};
     errorTooltipDisplayData = {};
    emailError;
    passwordError;
